// src/data/teams/dance-club.mjs
//
// Current Dance Club board. Snapshotted into docs/archive/dance-club/ at
...
export const CURRENT_TEAM = [
  { name: 'Shailu Gattineni', role: 'President' },
  { name: 'Nishith', role: 'Vice President' },
