// src/data/teams/photography-club.mjs
//
// Current Photography Club board. Snapshotted into docs/archive/photography-club/ at
...
export const CURRENT_TEAM = [
  { name: 'Anish Palacherla', role: 'President' },
  { name: 'Prakash Banu', role: 'Vice President' },
