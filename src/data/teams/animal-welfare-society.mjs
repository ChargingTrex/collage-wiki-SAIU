...
//
// Current Animal Welfare Society board. Snapshotted into docs/archive/animal-welfare-society/ at
...
// No Vice President was listed in that source. The canonical demo of the
// optional photo/contact fields lives in astronomy-club.mjs instead (see
// tests/e2e/leadership-rollover.spec.js), so this file doesn't duplicate
// that placeholder demo.

export const CURRENT_TEAM = [
  { name: 'Akshata Nagaraj', role: 'President' },
