// src/data/teams/martial-arts-club.mjs
//
// Current Martial Arts Club board. Snapshotted into docs/archive/martial-arts-club/ at
...
export const CURRENT_TEAM = [
  { name: 'Sri Sahanaa Muralitharan', role: 'President' },
  { name: 'Rathinakumar S', role: 'Vice President' },
