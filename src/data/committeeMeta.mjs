...
// committee — "Current Committee" on the Cultural Society page (the
// entity's display name changed from "Cultural Committee", but its
// leadership group is still, correctly, called a "committee" — the slug
// `cultural-committee` was kept too, so nothing downstream had to change),
// "Current Government" on Student Government's — unlike clubs, which are
// uniformly "Board") and example roles for the fresh placeholder team
// after a rollover.
